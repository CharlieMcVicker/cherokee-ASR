...
Dynamically applies character-specific vowel deletion penalties and aspiration
insertion discounts over an underlying DistanceMetric (e.g. ConfusionMatrixCostMetric)
without modifying weight artifacts on disk.
"""
