...
def main():
    parser = argparse.ArgumentParser(
        description="Extract audio segments and write a manifest JSON."
    )
    parser.add_argument("audio_path", help="Path to input audio file")
    parser.add_argument(
        "--out-dir",
        default="data/processed/segments",
        help="Directory to save extracted segments (default: data/processed/segments)",
    )
    parser.add_argument(
        "--thresh",
        type=int,
        default=-30,
        help="Silence threshold in dBFS (default: -30)",
    )
    parser.add_argument(
        "--min-silence",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=200,
        help="Keep silence padding in ms (default: 200)",
    )
    ...
    print(
        f"Segmenting audio (thresh={args.thresh}, min_silence={args.min_silence}, keep_silence={args.keep_silence})..."
    )
