# -*- coding: utf-8 -*-
"""
transcription.core.codeswitching.projector
...
from transcription.core.codeswitching.g2p import G2PEngine, get_default_g2p
from transcription.core.codeswitching.matrix import AcousticConfusionMatrix
