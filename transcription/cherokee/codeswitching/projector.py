...
from transcription.cherokee.orthography import convert_orthography
...
class SyntheticTargetProjector:
    ...
    def _load_dictionary(self, source: Union[str, Path, Dict[str, Any]]) -> None:
        ...
        self._static_dict = get_english_loanwords_tth_dict(path)
...
def get_default_projector(
    ...
    dict_arg = dict_resolved if dict_resolved.exists() else None
