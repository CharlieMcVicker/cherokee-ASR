# -*- coding: utf-8 -*-
"""
digohwelisgi.pipelines.dialogue.pipeline module.
...
2. Token discrimination via CodeSwitchedPreparer from digohwelisgi.cherokee.codeswitching,
...
4. Optional Silero VAD soft-masking via digohwelisgi.core.audio.masking.
5. Syncope- and intrusion-aware CTC segmentation via CTCSegmentationAligner (digohwelisgi.core.alignment.ctc).
6. Phonetic syllabary reconciliation via digohwelisgi.cherokee.enrichment.
7. Assembling and exporting canonical 7-tier Praat TextGrids:
   ...
   - Phoneme
   and structured JSON manifests via digohwelisgi.core.exporters.
"""
...
from digohwelisgi.core.alignment.ctc import DEFAULT_CACHE_DIR
...
from digohwelisgi.cherokee.phonotactics import (
    PhonemeCategory,
    PhonotacticToken,
...
from digohwelisgi.core.alignment.ctc import (
...
def align_syllabary_ctc(
    ...
    Maintains exact backwards compatibility with digohwelisgi.alignment.pipeline.align_syllabary_ctc.
    """
...
def align_syllabary_greedy(
    ...
    Maintains exact backwards compatibility with digohwelisgi.alignment.pipeline.align_syllabary_greedy.
    """
    from digohwelisgi.alignment.ingestion import load_syllabary_transcript
