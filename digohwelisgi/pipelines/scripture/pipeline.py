...
Composes Tier 1 CTCSegmentationAligner (digohwelisgi.core.alignment.ctc) and Tier 2
prepare_cherokee_text (digohwelisgi.cherokee.phonotactics) with ModelOutput universal currency,
...
from digohwelisgi.core.exporters.textgrid import export_textgrid
...
def align_chapter(
    ...
    from digohwelisgi.alignment.cli import run_alignment_pipeline
