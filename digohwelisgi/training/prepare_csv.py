...
import contextlib
import csv
from digohwelisgi.cherokee.orthography import remove_tones_and_double_vowels
...
def main():
    ...
    parser.add_argument(
        "--csv",
        type=str,
        default="data/training/processed/sentence_audio.csv",
        help="Path to the input CSV file containing metadata (default: data/training/processed/sentence_audio.csv)",
    )
    parser.add_argument(
        "--audio-dir",
        type=str,
        default="data/training/processed/sentence_audio",
        help="Path to the directory containing audio files (default: data/training/processed/sentence_audio)",
    )
    parser.add_argument(
        "--text-col",
        type=str,
    ...
    parser.add_argument(
        "--output-prefix",
        type=str,
        default="data/training/processed/cim-wav2vec2",
        help="Prefix for the generated train/valid/test split CSV files (default: data/training/processed/cim-wav2vec2)",
    )
    parser.add_argument(
        "--max-duration",
        type=float,
