...
intrusive site masking, and prepare_cherokee_text in digohwelisgi.cherokee.phonotactics.
"""
...
from digohwelisgi.core.alignment.ctc import TextPreparerProtocol
