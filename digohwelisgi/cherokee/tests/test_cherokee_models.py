...
Unit tests for digohwelisgi.cherokee.models.
...
from digohwelisgi.cherokee.models import (
...
@patch("digohwelisgi.cherokee.models.loader.get_model")
...
@patch("digohwelisgi.cherokee.models.loader.get_best_model_config")
@patch("digohwelisgi.cherokee.models.loader.get_model")
...
@patch("digohwelisgi.cherokee.models.loader.CherokeeASRModel.get_best_model")
