# -*- coding: utf-8 -*-
"""
digohwelisgi.apps.cli module.

Central CLI entrypoint for Cherokee ground-truth timestamp alignment.
Delegates to domain-specific pipelines:
- ScripturePipeline (digohwelisgi.pipelines.scripture) for Bible verse chapter alignment
- DialogueAlignmentPipeline (digohwelisgi.pipelines.dialogue) for code-switched or syllabary transcripts
- SlidingWindowDTWAligner / NeedlemanWunschWordAligner (digohwelisgi.alignment) for custom DTW / chunk-list alignment
- EnrichmentPipeline (digohwelisgi.pipelines.enrichment) for syllabary phonetic reconciliation
"""
...
from digohwelisgi.cherokee.codeswitching.types import SyntheticTargetProjectorProtocol
...
from digohwelisgi.alignment.reconciliation import reconcile_alignment_words
