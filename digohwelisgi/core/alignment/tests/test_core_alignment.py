...
Unit tests for digohwelisgi.core.alignment:
...
def test_wagner_fischer_aligner():
    from digohwelisgi.core.alignment.dp import WagnerFischerAligner
...
def test_forced_aligner_word_span():
    from digohwelisgi.core.alignment.forced_aligner import AlignedWordSpan
