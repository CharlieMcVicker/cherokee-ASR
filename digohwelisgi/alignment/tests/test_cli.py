# -*- coding: utf-8 -*-
"""
Unit tests for CLI runner in digohwelisgi.alignment.cli.
"""
...
from digohwelisgi.apps.cli import main, run_alignment_pipeline
...
def test_cli_main_argument_parsing(tmp_path):
    ...
    with patch.object(sys, "argv", test_args):
        with patch("digohwelisgi.apps.cli.run_alignment_pipeline") as mock_run:
            main()
