...
from digohwelisgi.alignment.models import AlignmentOutput, CTCAlignerConfig
from digohwelisgi.pipelines.dialogue import (
    align_syllabary_ctc,
    align_syllabary_greedy,
)
...
def test_build_syllabary_word_tier_length_mismatch_raises_value_error():
    ...
    from digohwelisgi.pipelines.dialogue import build_syllabary_word_tier
...
def test_build_english_word_tier_length_mismatch_raises_value_error():
    ...
    from digohwelisgi.pipelines.dialogue import build_english_word_tier
