...
def test_ctc_aligner_full_chapter_verse_and_word_harvesting():
    from digohwelisgi.alignment.models import TextChunk
...
def test_ctc_aligner_zero_start_timing_preserved(dummy_audio_file: Path):
    ...
    with patch(
        "digohwelisgi.alignment.ctc_aligner.ctc_segmentation",
...
def test_ctc_aligner_align_unaligned_word_and_window_size():
    ...
    with (
        ...
        patch(
            "digohwelisgi.alignment.ctc_aligner.determine_utterance_segments",
...
def test_ctc_aligner_parameters_forwarding(dummy_audio_file: Path):
    ...
    with (
        ...
        patch(
            "digohwelisgi.alignment.ctc_aligner.prepare_cherokee_text",
...
def test_ctc_aligner_with_vad_soft_masking(tmp_path: Path):
    ...
    with patch.object(
        ...
        with patch(
            "digohwelisgi.alignment.ctc_aligner.mask_non_speech_logits",
